...
export function getNameOfTheDay(): Name {
  ...
  // Find the complete name record by orderNumber to ensure we get all properties including id
  return namesData.find(name => name.orderNumber === selectedName.orderNumber) || namesData[0]
}